  ...
  return (
    <div className="bg-spring_wood bg-home_page bg-cover bg-fixed bg-center bg-no-repeat min-h-screen text-black">
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
        ...
        <div className="spacer w-[180px]"></div>

       
        <div className="w-full lg:w-[700px] p-4 ">
          <h3 className="text-2xl font-bold uppercase mb-6">My Profile</h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="border border-black rounded-lg shadow-md h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">Juan</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="border border-black rounded-lg shadow-md  h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">De Kimmie</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="border border-black rounded-lg shadow-md h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">*********69</span>
                </div>
              </div>
              <div>
                <p className="text-gray-700 font-semibold">Email</p>
                <div className="border border-black rounded-lg shadow-md h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">JuanDekimmieisemo@gmail.com</span>
                </div>
              </div>
            </div>
...
>
  ...
  />
              ...
              <div>
                ...
                <div className="border border-black rounded-lg shadow-md w-[340px] h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">male</span>
                </div>
              </div>
              <div>
                <p className="text-gray-700 font-semibold">Birthday</p>
                <div className="border border-black rounded-lg shadow-md w-[340px] h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">05/05/1997</span>
                </div>
              </div>
            </div>
          </div>
