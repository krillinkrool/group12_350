  ...
  return (
    <div className="bg-navbar_white bg-home_page bg-cover bg-center bg-no-repeat min-h-screen text-black">
      ...
      <ul className="absolute">
        <Image 
            src="/images/KIMMIE/logo variations/trans.png"
            width={450}
            height={450}
            alt="An image of a skull"
          />
          <h1 className="absolute bottom-3 inset-x-0 text-center font-medium">FOR THE REBELLIOUS SOUL</h1>
      </ul>
      </div>
    </div>
  );
