  ...
  return (
    <div className="bg-spring_wood bg-home_page bg-cover bg-fixed bg-center bg-no-repeat min-h-screen text-black">
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
              ...
              <span className="text-[30px] d" >My Profile</span>
            </Link>
            <Link href="/screens/address_page" className="flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" className="size-10">
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" class="size-10">
      <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
        ...
        {/* Divider */}
        <div className="hidden lg:block w-[2px] bg-black opacity-60 mx-4 ml-[-50px]"></div>

       
        <div className="w-full lg:w-[700px] p-4">
          <h3 className="text-2xl font-bold uppercase mb-6">My Address</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="border border-black rounded-lg shadow-md h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">Visayas</span>
                </div>
              </div>
              <div>
                <p className="text-gray-700 font-semibold">Province</p>
                <div className="border border-black rounded-lg shadow-md h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">Iloilo</span>
                </div>
              </div>
              <div>
                <p className="text-gray-700 font-semibold">Street Name, Building, House No.</p>
                <div className="border border-black rounded-lg shadow-md h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">Lopez Jaena Street</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="border border-black rounded-lg shadow-md w-[190px] h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">Iloilo City</span>
                </div>
              </div>
              <div>
                <p className="text-gray-700 font-semibold">Barangay</p>
                <div className="border border-black rounded-lg shadow-md w-[190px] h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">Jaro</span>
                </div>
              </div>
              <div>
                <p className="text-gray-700 font-semibold">Zip Code</p>
                <div className="border border-black rounded-lg shadow-md w-[190px] h-[40px] flex items-center px-4">
                  <span className="text-black opacity-60">5000</span>
                </div>
              </div>
            </div>
          </div>
