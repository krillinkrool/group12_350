...
// group12_350/app/components
// group12_350/app/components/aboutPage.jsx
...
//           <div>
//     </div>
//     {/* <Link href="/"><svg className="absolute top-0 left-0" width="110" height="119" viewBox="0 0 129 119" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M63.3333 36.5L38 59.5M38 59.5L63.3333 82.5M38 59.5H88.6667M126.667 59.5C126.667 91.2564 98.3114 117 63.3333 117C28.3553 117 0 91.2564 0 59.5C0 27.7436 28.3553 2 63.3333 2C98.3114 2 126.667 27.7436 126.667 59.5Z" stroke="#F3F3F3" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/></svg></Link> */}
//     <div className="flex min-h-screen">
//       {/* Left Side */}
//       <div
//         className="w-[40%] bg-cover"
//         style={{ backgroundImage: "url('/images/KIMMIE/photoshoot/img2.jpg')" }}
//       >
...
//           <h1 className="text-8xl font-bold items-start text-white mb-4">
//             KIM MIE CO.
//           </h1>
//         </div>
...
//             KIMMIE provides high-quality
//             clothing to innovative individuals in a
//             bold and creative environment while helping them feel empowered and giving them a sense of belonging to a community that celebrates individuality and creativity.
//           </h3>
//         </div>
        
//       </div>
//     </div>
//     <div className="border-red border-2 justify-self-center"><AboutPage/></div>
//     </div>
//   );
// }
...
//       <br>
//       </br>
//       <footer className="bg-black  py-16 px-96">
//           <div className="grid grid-cols-3 gap-96">
//             {/* Left Column */}
//             <div>
//   <h2 className="font-bold text-5xl mb-4">KIMMIE CO.</h2>
...
//             {/* Contacts Column */}
//             <div>
//               <h3 className="font-bold text-lg w-[400px] mb-4">CONTACTS</h3>
//               <ul className="text-sm space-y-2">
...
// export default transition(About_Page);

// Header or Imports Section
import Image from "next/image";
import AboutPage from "../../components/AboutPage.jsx";
import Link from "next/link";
import transition from "../../transition.js";
